	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					管理员编辑信息 <small><jsp:include page="../icd_time.jsp"></jsp:include></small>
				</h1>
				<ol class="breadcrumb">
				...
				<div class="col-md-12">
					...
					<div class="box box-info" style="border-radius: 12px;">
						...
						<form class="form-horizontal"
							action="${ctx}/mng/member/updatemember?id=<%=member.getId() %>"
							method="post">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="pwd" name="pwd"
											value="<%=member.getPwd()%>" placeholder="请输入密码">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="username"
											value=<%=member.getNick_name()%> name="username"
											placeholder="请输入昵称">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="email"
											value="<%=member.getEmail()%>" name="email"
											placeholder="请输入邮箱 ">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="mobile"
											value=<%=member.getMobile()%> name="mobile"
											placeholder="请输入联系方式 ">
									</div>
								</div>
								
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">注册时间
									</label>

									<div class="col-sm-10">
										<input type="text" class="form-control" id="register_time"
											value="<%=member.getRegister_time()%>" name="register_time" />
									</div>
								</div>

								<input type="hidden" name="aaabbb" value="shijian" />
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										%>
										<input type="radio" id="inputEmail3" name="gender" value="1">男
										<input type="radio" id="inputEmail3" name="gender" value="0"
											checked="checked">女
										<%
											}
										%>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										%>
										<input type="radio" id="inputEmail3" name="isenable" value="1">
										有效<input type="radio" id="inputEmail3" name="isenable"
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" name="title" class="form-control"
												value="<%=member.getThumbnail()%>" readonly="readonly"
												id="btn_upload" placeholder="请选择要上传图片" style="height: 43px;"></input>
