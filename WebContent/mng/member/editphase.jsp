	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					阶段定义编辑信息 <small><jsp:include page="../icd_time.jsp"></jsp:include></small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="./main.html"><i class="fa fa-home"></i> 首页</a></li>
					<li><a href="#">报考信息管理</a></li>
					<li class="active"><a href="javascript:;">阶段定义编辑</a></li>
				</ol>
			</section>
				...
				<div class="col-md-12">
					...
					<div class="box box-info" style="border-radius: 12px;">
						<div class="box-header with-border">
							<h3 class="box-title">编辑阶段定义</h3>
						</div>
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal"
							action="${ctx}/mng/member/updatephase?id=${phase.id}"
							method="post">
							<div class="box-body">
									...
									<div class="col-sm-10">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												value='<fmt:formatDate  value="${phase.starttime }"  pattern="yyy-MM-dd HH:mm:ss"/>' />
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												class="fa  fa-calendar"></i></span> <input type="text"
												value='<fmt:formatDate  value="${phase.endtime }"  pattern="yyy-MM-dd HH:mm:ss"/>'
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="stagename"
											value="${phase.note }" name="note" placeholder="请输入备注">
									</div>
								</div>
