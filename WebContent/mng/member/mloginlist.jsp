	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					管理员登录信息 <small> <jsp:include page="../icd_time.jsp"></jsp:include>
					</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="./main.html"><i class="fa fa-home"></i> 首页</a></li>
					<li><a href="#">基本信息 </a></li>
					<li class="active"><a href="javascript:;">管理员登录信息 </a></li>
				</ol>
			</section>
					...
					<div class="box box-success">
						...
						<div class="box-body table-responsive">
							<table id="example"
								...
								<tbody>
									<c:forEach items="${list}" var="mlogin">
										<tr>
											<td>${mlogin.id}</td>
											<td>${member.username}</td>
											<td><fmt:formatDate value="${mlogin.logintime}"
